...
type Reader interface {
	...
	// BlockReverseIterator iterates over Blocks in reverse order, limiting the results to be between the provided block numbers
	...
	// TxReverseIterator iterates over transactions in reverse order, limiting the results to be between the provided block numbers
	// and transaction indexes
